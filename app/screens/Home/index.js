...
import getNotifRed from '../../selectors/NotifSelector';
...
const Home = props => {
  ...
  console.log('datanotif', route.params);
  ...
  console.log('cobaaaaaa liat ===>', notif);
  ...
  //   //   {text: 'Ok', onPress: () => navigation.navigate('Notification', notif)},
  //   // ]);
